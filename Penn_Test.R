...
SNP_Plot<-function(region){
  countrydf_for_SNP_Plot<-cbind("/Users/carissa/StaphopiaProject/OldDF_",region,".rda")
  countrydf_for_SNP_Plot_str<-str_c(countrydf_for_SNP_Plot, collapse="")
  print(countrydf_for_SNP_Plot_str)
  load(countrydf_for_SNP_Plot_str)
...
server <- function(input, output, session) {
  ...
  filteredData <- reactive({
    ...
    output$plot_SNPs<- renderPlot(SNP_Plot((sample_location[as.numeric(input$country)])))
